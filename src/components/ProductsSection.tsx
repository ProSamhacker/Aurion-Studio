...
const products = [
  ...
  },
  {
    icon: Video,
    name: "Visioscript",
    tagline: "AI Video Editing. From Script.",
...
const ProductsSection = () => {
  return (
    <section id="products" className="relative border-t border-border/60 bg-secondary/20 py-20 sm:py-28 overflow-hidden">
      {/* Background glows */}
      ...
      <div className="container relative mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <h2 className="font-heading text-3xl font-black text-foreground sm:text-5xl md:text-6xl text-balance">
            Proprietary <span className="text-gradient-orange">Software</span>
          </h2>
